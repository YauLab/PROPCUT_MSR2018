...
for k = 1:nSubject
    ...
    p_d2_ft = fit( [ac(1:3) ac(5:7)]', [p_d2(k,1:3) p_d2(k,5:7)]', ft, opts );
    plot(acGrid,p_d1_ft(acGrid),'k','LineWidth',0.5)
    plot(acGrid,p_d2_ft(acGrid),'r','LineWidth',0.5)
...
[h,p] = ttest2(base_sig(:,1), base_sig(:,2))
[h,p] = ttest2(base_mu(:,1), base_mu(:,2))
...
d2_fd_no = fit( [ac(1:3) ac(5:7)]', [prob_d2(1:3) prob_d2(5:7)]', ft, opts );
...
h00 = errorbar([ac(1:3) ac(5:7)],[prob_d2(1:3) prob_d1(5:7)],[er_d2(1:3) er_d1(5:7)],'o'); set(h00,'Color','r','MarkerFaceColor','k','MarkerSize',1e-10,'LineWidth',2)
...
% errorbar_tick(h0,0); errorbar_tick(h1,0); errorbar_tick(h2,0); errorbar_tick(h3,0); 
axis([0.05 0.75 -0.05 1]), set(gca,'YTick',[0 0.5 1],'XTick',[0.05 0.4 0.75])
...
% clf; subplot(223), hold on
% Individual PSe
mark = {'d','s','<','>','*','v','o','x'};
for subj = 1:8
    rng(subj)
    dx = randn/10;
    plot(X(1,:)+dx, (mu_2(subj,:)),mark{subj},'MarkerFaceColor','none','MarkerEdgeColor',[0.6 0.6 0.6],'MarkerSize',5)
    plot(X(2,:)+dx, (mu_4(subj,:)),mark{subj},'MarkerFaceColor','none','MarkerEdgeColor',[0.6 0.6 0.6],'MarkerSize',5)
    plot(X(3,:)+dx, (mu_7(subj,:)),mark{subj},'MarkerFaceColor','none','MarkerEdgeColor',[0.6 0.6 0.6],'MarkerSize',5)
end
...
% clf; subplot(224), hold on
% Individual JND
for subj = 1:8
    rng(subj)
    dx = randn/10;
    plot(X(1,:)+dx, (sigma_2(subj,:)),mark{subj},'MarkerFaceColor','none','MarkerEdgeColor',[0.6 0.6 0.6],'MarkerSize',5)
    plot(X(2,:)+dx, (sigma_4(subj,:)),mark{subj},'MarkerFaceColor','none','MarkerEdgeColor',[0.6 0.6 0.6],'MarkerSize',5)
    plot(X(3,:)+dx, (sigma_7(subj,:)),mark{subj},'MarkerFaceColor','none','MarkerEdgeColor',[0.6 0.6 0.6],'MarkerSize',5)
end
