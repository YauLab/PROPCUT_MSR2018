...
for i = 1:size(jnd,2)
    ...
    rng(i)
    dx = randn/10;
    plot(position+dx,PSE(:,i),mark{i},'LineWidth',0.5,'MarkerFaceColor','none','MarkerEdgeColor',[0.6 0.6 0.6],'MarkerSize',5)
    subplot(2,2,4)
    plot(position+dx,JND(:,i),mark{i},'LineWidth',0.5,'MarkerFaceColor','none','MarkerEdgeColor',[0.6 0.6 0.6],'MarkerSize',5)
end
